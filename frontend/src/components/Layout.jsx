...
const Layout = ({user, onLogout}) => {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='ml-0 xl:ml-64 lg:ml-64 md:ml-16 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-00'>
        <div className='grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6'>
          ...
          <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
            <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
              ...
              <hr className='my-3 md:my-4 border border-purple-200' />
            ...
            <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-r-purple-100'>
              <h3 className='tex-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800 flex items-center gap-2'>
              ...
              <div className='space-y-2 sm:space-y-3'>
                {tasks.slice(0, 3).map((task) => (
                  ...
                  <div
                    ...
                    className='flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50 rounded-lg transition-colors duration-200 border border-transparent hover:border-purple-100'
                  >
